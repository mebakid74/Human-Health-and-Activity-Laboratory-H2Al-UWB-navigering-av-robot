...
------------------
Projektet fokuserar på ett datorbaserat problem genom att följa $\textcolor{red}{\text{*Agilt*}}$ arbetssätt med *Scrum* som är en numera vanlig förekommande modell för projektarbete på $\textcolor{blue}{\text{Luleå Tekniska Universitet}}$ under handledning av **Kåre Synnes**.
